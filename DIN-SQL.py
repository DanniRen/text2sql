...
# API_KEY = "sk-CavCYs4JvBNPxFowTeoHWjuj7wRiVqqbKncP2vRaNSkFr6qd"
API_KEY = "17ff47d93e06a2b19f9d5f37fa3ad079.3n3j7LcQ0oYPXLcl"
...
def creatiing_schema(DATASET_JSON):
    ...
    for index, row in schema_df.iterrows():
        ...
        for foreign_key in foreign_keys:
            # foreign_key is a dict with "column_id" and "other_column_id"
            first = foreign_key["column_id"]
            second = foreign_key["other_column_id"]
            first_index, first_column = first
            second_index, second_column = second
            
            # Check if indices are within bounds
            if first_index >= len(tables) or second_index >= len(tables):
                continue
...
if __name__ == "__main__":
    ...
    for index, row in val_df.iterrows():
        ...
        while classification is None:
            try:
                classification = GPT5_generation(
